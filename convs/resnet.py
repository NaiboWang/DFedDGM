...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None,args=None, in_channels=3):
        ...
        if 'cifar' in args["dataset"] or 'emnist' in args["dataset"] or 'svhn' in args["dataset"]:
            self.conv1 = nn.Sequential(nn.Conv2d(in_channels, self.inplanes, kernel_size=3, stride=1, padding=1, bias=False),
